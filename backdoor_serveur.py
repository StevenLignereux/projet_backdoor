...
def socket_recive_all_data(socket_p, data_len):
    current_data_len = 0
    total_data = None
...
while True:
    ...
    header_data = socket_recive_all_data(connection_socket, 13)
    longeur_data = int(header_data.decode())

    data_recues = header_data = socket_recive_all_data(connection_socket, longeur_data)
